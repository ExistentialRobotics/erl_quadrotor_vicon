...
ViconOdom::ViconOdom(ros::NodeHandle &nh)
{
  ...
  vicon_sub_ = nh.subscribe("/vicon/robot_1/robot_1", 10, &ViconOdom::ViconCallback,
                            this, ros::TransportHints().tcpNoDelay());
}

void ViconOdom::ViconCallback(const geometry_msgs::TransformStampedConstPtr &msg)
{
  ...
  odom_msg.pose.pose.orientation = msg->transform.rotation;
